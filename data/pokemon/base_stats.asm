...
INCLUDE "data/pokemon/base_stats/pidegotto.asm"
...
INCLUDE "data/pokemon/base_stats/porygon_b.asm"
...
INCLUDE "data/pokemon/base_stats/jyaggu.asm"
INCLUDE "data/pokemon/base_stats/grabwyrm.asm"
